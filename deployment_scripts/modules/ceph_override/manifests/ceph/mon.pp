# NOTE (dukov) Copied from osnailyfacter::ceph::mon
class ceph_override::ceph::mon {
  ...
  # NOTE (dukov)Do not merge ceph_monitor_nodes
  ...
  # NOTE(dukov) removed code section that affected by https://bugs.launchpad.net/fuel/+bug/1603409
  }
