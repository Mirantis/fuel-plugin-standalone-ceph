class ceph_override::openstack_haproxy::ssl_keys_saving {


  $public_ssl_hash = hiera_hash('standalone-ceph')
  $ssl_hash = hiera_hash('use_ssl', {})
  $pub_certificate_content = try_get_value($public_ssl_hash, 'certificate/content', '')
